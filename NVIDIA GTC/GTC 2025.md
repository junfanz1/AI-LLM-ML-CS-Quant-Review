...
<div style="display: table; margin: auto; border: 1px solid lightgray; padding: 5px; width: 50%; max-width: 300px;">
  <table style="width: 100%;">
    ...
    <tr>
      <td align="center">
        <em>A project that integrates AI, humanoid robots, and the low-altitude economy.</em>
      </td>
    </tr>
  </table>
</div>
