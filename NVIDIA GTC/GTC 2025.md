...
### GPU performance bottlenecks for LLM workloads
...
- Hybrid LLM: Hymba Architecture
  - Better results by combining layers in parallel, take state space model in pink, and regular transformer, we have sliding window layer (less expensive transformer), sharing the KV-Cache.
...
### GenMol: Drug Discovery with Small Molecule Generation
