...
- Ray tune for distributed hyperparameter optimization (HPO), 1000 experiments to tune KAN architecture and learning params on training and validation.
...
- Challenges with pykan during HPO: NaNs with LBFGS and Adam optimizers when employing large values for grid refinement of splines.
