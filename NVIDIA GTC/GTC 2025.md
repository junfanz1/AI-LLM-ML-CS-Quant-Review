...
- How to evaluate/score the exploring space of trajectories and exhaustive CoT of AI reasoning? Simply generating more/repeated tokens is not effective reasoning, we should corporate into structured way as part of training.
...
- Drifts of fine-tuning models, especially if we don't know the distribution of pretrained data, how to involve others to participate? From checkpoint to checkpoint, what happened to the model?
