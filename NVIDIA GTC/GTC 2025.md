...
[Slides](https://static.rainfocus.com/nvidia/gtcs25/sess/1727321215230001Bhv2/FinalPresPDF/S72498_1741760325928001kU80.pdf)

UFO-Lite
- First work on MLLMs-SPD and orthogonal to previous work on LLMs
- Implement based on TensorRT-LLM
- Can be applied to any state-of-the-art MLLMs
- Enhanced with FP8 and deployed on L20
- 小模型自回归k次迭代，大模型一次并行处理
- 大小模型协同：小模型做错/幻觉了被大模型修正，小模型不够自信让大模型验证。
- Online Post-training Quantization, Model Distillation
