...
- [Pre-Retrieval Optimizing Indexing](#pre-retrieval-optimizing-indexing)
   * [Multi-Representation Indexing for Enhanced Search Results](#multi-representation-indexing-for-enhanced-search-results)
   * [Self-Querying Retrieval (SQR): Automating Query Formulation](#self-querying-retrieval-sqr-automating-query-formulation)
   * [Parent Document Retrieval (PDR): Structuring Hierarchical Data](#parent-document-retrieval-pdr-structuring-hierarchical-data)
- [​​Pre-Retrieval Query Optimization](#pre-retrieval-query-optimization)
   * [Multi-Query Techniques for Complex Information Retrieval](#multi-query-techniques-for-complex-information-retrieval)
   * [Query Decomposition for Better Precision](#query-decomposition-for-better-precision)
   * [Step-Back Prompting: Adjusting Queries Dynamically](#step-back-prompting-adjusting-queries-dynamically)
   * [Hypothetical Document Embeddings (HyDE): Simulating Context](#hypothetical-document-embeddings-hyde-simulating-context)
   * [Routing](#routing)
      + [Semantic Routing: Directing Queries Based on Intent](#semantic-routing-directing-queries-based-on-intent)
      + [Routing with LLM-Based Classifiers for Complex Tasks](#routing-with-llm-based-classifiers-for-complex-tasks)
- [Post-Retrieval Optimization](#post-retrieval-optimization)
   * [Using RAG-Fusion for Better Context](#using-rag-fusion-for-better-context)
...
<!-- TOC --><a name="pre-retrieval-optimizing-indexing"></a>
# Pre-Retrieval Optimizing Indexing

<!-- TOC --><a name="multi-representation-indexing-for-enhanced-search-results"></a>
...
<!-- TOC --><a name="self-querying-retrieval-sqr-automating-query-formulation"></a>
...
<!-- TOC --><a name="parent-document-retrieval-pdr-structuring-hierarchical-data"></a>
...
<!-- TOC --><a name="pre-retrieval-query-optimization"></a>
# ​​Pre-Retrieval Query Optimization

<!-- TOC --><a name="multi-query-techniques-for-complex-information-retrieval"></a>
...
<!-- TOC --><a name="query-decomposition-for-better-precision"></a>
...
<!-- TOC --><a name="step-back-prompting-adjusting-queries-dynamically"></a>
## Step-Back Prompting: Adjusting Queries Dynamically
...
<!-- TOC --><a name="hypothetical-document-embeddings-hyde-simulating-context"></a>
...
<!-- TOC --><a name="semantic-routing-directing-queries-based-on-intent"></a>
...
<!-- TOC --><a name="routing-with-llm-based-classifiers-for-complex-tasks"></a>
...
<!-- TOC --><a name="post-retrieval-optimization"></a>
...
<!-- TOC --><a name="using-rag-fusion-for-better-context"></a>
...
<!-- TOC --><a name="cross-encoder-reranking"></a>
