...
- [DeepSeek‑V3](#deepseekv3)
   ...
   * [DeepSeek Experts](#deepseek-experts)
   * [How are DeepSeek’s gating mechanism and routing different?](#how-are-deepseeks-gating-mechanism-and-routing-different)
   * [Multi-Latent Head Attention](#multi-latent-head-attention)
   * [Multi-Token prediction](#multi-token-prediction)
   * [FP8 mixed precision training](#fp8-mixed-precision-training)
   * [Parallelism](#parallelism)
      + [DualPipe pipeline parallelism: Reducing communication overhead](#dualpipe-pipeline-parallelism-reducing-communication-overhead)
      + [Expert parallelism + ZeRO data parallelism: Handling MoE efficiently](#expert-parallelism-zero-data-parallelism-handling-moe-efficiently)
- [DeepSeek‑R1](#deepseekr1)
   * [R1-Zero: Group Relative Policy Optimization (GRPO)](#r1-zero-group-relative-policy-optimization-grpo)
   * [R1 vs. R1-Zero](#r1-vs-r1-zero)
      + [How does the cold start data improve readability?](#how-does-the-cold-start-data-improve-readability)
      + [How is the reasoning-oriented RL conducted?](#how-is-the-reasoning-oriented-rl-conducted)
      + [What’s rejection sampling and fine-tuning?](#whats-rejection-sampling-and-fine-tuning)
      + [Why another RL pass for all scenarios?](#why-another-rl-pass-for-all-scenarios)
- [Making Distilled Models from DeepSeek-R1](#making-distilled-models-from-deepseek-r1)
...
<!-- TOC --><a name="mixture-of-experts-moe"></a>
...
<!-- TOC --><a name="how-are-deepseeks-gating-mechanism-and-routing-different"></a>
## How are DeepSeek’s gating mechanism and routing different?
...
<!-- TOC --><a name="multi-latent-head-attention"></a>
...
<!-- TOC --><a name="multi-token-prediction"></a>
...
<!-- TOC --><a name="fp8-mixed-precision-training"></a>
...
<!-- TOC --><a name="parallelism"></a>
## Parallelism


<!-- TOC --><a name="dualpipe-pipeline-parallelism-reducing-communication-overhead"></a>
### DualPipe pipeline parallelism: Reducing communication overhead
...
<!-- TOC --><a name="expert-parallelism-zero-data-parallelism-handling-moe-efficiently"></a>
### Expert parallelism + ZeRO data parallelism: Handling MoE efficiently



<!-- TOC --><a name="deepseekr1"></a>
# DeepSeek‑R1
...
<!-- TOC --><a name="r1-zero-group-relative-policy-optimization-grpo"></a>
## R1-Zero: Group Relative Policy Optimization (GRPO)
...
<!-- TOC --><a name="how-does-the-cold-start-data-improve-readability"></a>
### How does the cold start data improve readability?
...
<!-- TOC --><a name="how-is-the-reasoning-oriented-rl-conducted"></a>
### How is the reasoning-oriented RL conducted?
...
<!-- TOC --><a name="whats-rejection-sampling-and-fine-tuning"></a>
### What’s rejection sampling and fine-tuning?
...
<!-- TOC --><a name="why-another-rl-pass-for-all-scenarios"></a>
### Why another RL pass for all scenarios?
...
<!-- TOC --><a name="making-distilled-models-from-deepseek-r1"></a>
